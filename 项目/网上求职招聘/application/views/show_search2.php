    ...
    <div class="left">
        ...
        <div class="box1 shadow">
        	<div class="tit">
                ...
                <div class="titText">
                	<div class="fr">
                        <a data-id="<?php echo $recruit->recruit_id;?>" class="btnC3 box1T3 company_detail"><?php echo $recruit->recruit_name;?></a><br /><br />
        ...
        <a data-id="<?php echo $recruit->recruit_id;?>" class="box1More shadow company_detail">查看详情</a>
        <?php
            }
          ?>
        <!-- 一条记录 结束 -->
