...
<div class="main">
	...
	<div class="left">
        ...
        <div class="box1 shadow">
        	...
        	<form action="company/add_recruit" method="post">  
            <table class="TB2">
                <tr>
                    <th>企业名称：</th>
                    <td>
                    	<input class="TB2Input" name="company_name" type="text" />
                    </td>
                    <th>工作地点：</th>
                    <td><input class="TB2Input" name="recruit_address" type="text" /></td>
                </tr>
                <tr>
                    <th>需求岗位：</th>
                    <td><input class="TB2Input" name="recruit_name" type="text" /></td>
                    <th>岗位类别：</th>
                ...
                <tr>
                    <th>薪资待遇：</th>
                    <td>
                    	<input class="TB2Input" name="recruit_salary" type="text" />
                    </td>
                    <th>招聘人数：</th>
                    <td><input class="TB2Input" name="recruit_num" type="text" />
                ...
                <tr>
                    <th>岗位要求：</th>
                    <td colspan="3"><textarea name="recruit_detail" class="TB2Textarea"></textarea></td>
                </tr>
                <tr>
                    <th>企业介绍：</th>
                    <td colspan="3"><textarea name="company_detail" class="TB2Textarea"></textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4">
                        <hr class="line" />
                        <input type="submit" class="TB2Btn1"value="发布" />
